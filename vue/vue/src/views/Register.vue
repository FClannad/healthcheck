<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: white">欢 迎 注 册</div>
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item>
          <el-button size="large" type="primary" style="background-color: #2562ec; width: 100%" @click="login">注 册</el-button>
        </el-form-item>
        <div style="text-align: right">
          已有账号？请 <a style="color: #2562ec" href="/login">登录</a>
        </div>
      </el-form>
    </div>
  </div>
...
.login-container {
  ...
  align-items: center;
  background-image: url("@/assets/imgs/jing.jpg");
